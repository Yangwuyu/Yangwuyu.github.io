...
import com.digiwin.testdap.basic.service.impl.IDemoHelloService;

public class DemoHelloService implements IDemoHelloService {
    ...
    public DWServiceResult getHello(String name) throws Exception {
        ...
        if (name == null || name.length() == 0) throw new DWArgumentException("name", "name is null or empty!");
